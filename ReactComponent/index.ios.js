...
var ForLiftCycle = require('./forlifecycle');

var ForNativeModule = require('./forNativeModule.js');
...
//            component:ForNetWork
    ...
    _renderFooter:function(){
        return (
                <View>
                <Text onPress={this._footer1clicked}>this is a table footer1 forNativeModule</Text>
                <Text onPress={this._footer2clicked}>this is a table footer2 ForLiftCycle</Text>
                </View>
        );
    },

    _footer2clicked:function(){
        console.log('footer1clicked...');
    ...
    _footer1clicked:function(){
        console.log('footer1clicked...');
        
        this.props.navigator.push({
            name:'footer clicked',
            component:ForNativeModule,
            title: 'ForNativeModule'
        });
